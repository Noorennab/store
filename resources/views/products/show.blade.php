...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <h1 class="my-4">store info</h1>
                <div class="list-group">
                    <a href="/stores/{{$product->id}}" class="list-group-item active">{{$product->store->name}}</a>
                    <a href="{{$product->store->fb_page}}" class="list-group-item">Facebook Page</a>
                    <a href="#" class="list-group-item">Location: {{$product->store->store_locate}}</a>
